...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_services_icon" AS ENUM('shield', 'gavel', 'scale', 'family', 'customs', 'land', 'briefcase', 'contract');
  CREATE TYPE "public"."enum_leads_status" AS ENUM('new', 'in-progress', 'done');
  CREATE TYPE "public"."enum_site_settings_socials_icon" AS ENUM('facebook', 'instagram', 'telegram', 'viber', 'whatsapp');
  ...
  CREATE TABLE "services" (
  	...
  	"icon" "enum_services_icon" DEFAULT 'scale' NOT NULL,
  	"price_from" numeric,
  ...
  CREATE TABLE "site_settings_socials" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" "enum_site_settings_socials_icon" NOT NULL,
  ...
  CREATE TABLE "site_settings_extra_areas" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL
  ...
  ALTER TABLE "site_settings_extra_areas" ADD CONSTRAINT "site_settings_extra_areas_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "services_service_id_idx" ON "services" USING btree ("service_id");
  ...
  CREATE INDEX "site_settings_extra_areas_order_idx" ON "site_settings_extra_areas" USING btree ("_order");
  CREATE INDEX "site_settings_extra_areas_parent_id_idx" ON "site_settings_extra_areas" USING btree ("_parent_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "site_settings_extra_areas" CASCADE;
